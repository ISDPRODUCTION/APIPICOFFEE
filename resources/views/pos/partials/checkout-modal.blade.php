...
<div id="success-modal"
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm z-10 p-8 text-center">
        ...
        <div class="space-y-3">
            <button id="new-order-btn" onclick="document.getElementById('success-modal').classList.add('hidden')"
               class="flex w-full items-center justify-center gap-2 py-3.5 bg-[#F97316] hover:bg-[#EA580C] text-white rounded-2xl text-sm font-semibold transition-colors shadow-lg shadow-orange-200">
            ...
            <a id="print-receipt-btn" href="#"
               class="flex w-full items-center justify-center gap-2 py-3.5 border-2 border-[#F97316] text-[#F97316] rounded-2xl text-sm font-semibold hover:bg-orange-50 transition-colors">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
